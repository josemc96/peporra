...
const styles = StyleSheet.create({
  ...
  memberAvatar: { backgroundColor: '#232B42' },
  memberAlias: { flex: 1 },
  revealedBadge: { color: '#8892A4', fontWeight: '700' },
  predictedBadge: { color: '#22C55E', fontWeight: '700' },
  ...
  userChip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#1C2236', borderRadius: 20, paddingHorizontal: 10, paddingVertical: 4 },
  chipAvatar: { backgroundColor: '#232B42' },
  chipCardEmojis: { fontSize: 13, lineHeight: 18 },
  userPts: { color: '#22C55E', fontWeight: '700' },
  userPtsZero: { color: '#FF4D6D' },
  noPredLabel: { opacity: 0.5 },
  error: { color: '#FF4D6D', textAlign: 'center', marginTop: 32 },
